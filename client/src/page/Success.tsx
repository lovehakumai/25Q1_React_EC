...
const Success = () => {
        ...
        if(!sessionId){
            ...
            const saveOrder = async ()=>{
                try {
                    ...
                    toast.success("Payment accesped successfully & order saved!!")
                    resetCart();
                } catch (error) {
    ...
    return (
        <Container>
            {loading && <Loading />}
            <div className="min-h-[400px] flex flex-col items-center justify-center pay-y-5">
                ...
                <p>
                    {loading ? "Once done" : "Now"} you can view your Orders or continue Shopping with us
                </p>
