...
const Login = ({ setLogin }: {setLogin:(login: boolean)=>void }) => {
    ...
    return (
        <div className="bg-gray-950 rounded-lg">
            <form
                ...
                className="max-w-5xl mx-auto pt-10 lg:px-0 text-whiteText"
            >
                ...
                <div className="border-b border-b-white/10 pb-5">
                    <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                            ...
                            className="w-full rounded-md border-0 bg-white/5 py-1.5 px-4 outline-none text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-skyText sm:text-sm sm:leading-6 mt-2"
                            />
                        </div>
                        <div className="sm:col-span-3">
