  ...
  export const highlightsProducts = [
    {
      ...
      image: "https://picsum.photos/400/300?random=1", // ランダム画像(ショッピング用)
      _base: "/product",
      color: "#000000",
    },
    {
      ...
      image: "https://picsum.photos/400/300?random=2", // ランダム画像(スマホ用)
    ...
    },
    {
      ...
      image: "https://picsum.photos/400/300?random=3", // ランダム画像(パワーバンク用)
      _base: "/product",
      color: "#ffffff",
    },
  ];
