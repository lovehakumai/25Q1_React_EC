    ...
    return (
        <Container>
            {cartProduct.length > 0 ? (
                ...
                <div className="bg-whiteText h-96 flex flex-col gap-2 items-center justify-center py-5 rounded-lg border border-gray-200 drop-shadow-2xl">
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                        Shopping Cart
                    </h1>
                    <p className="text-lg max-w-[600px] text-center text-gray-600 tracking-wide leading-6">
                        YOUR CART IS EMPTY.<br/>
                        TIME TO FIND GREAT PRODUCTS.
                    </p>
                    <Link 
                        to={"/product"}
                        className="bg-gray-200 text-gray-900 px-8 py-4 rounded-md hover:bg-black hover:text-white duration-200 uppercase font-semibold tracking-wide">
                            Go to Shopping
                        </Link>
                </div>
            )}
